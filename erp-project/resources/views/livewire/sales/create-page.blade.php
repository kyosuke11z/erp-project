<div>
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <div class="flex items-center space-x-4">
                {{-- ปุ่มยกเลิกจะพาผู้ใช้กลับไปหน้ารายการ --}}
                <a href="{{ route('sales.index') }}" wire:navigate class="flex items-center space-x-2 text-gray-500 hover:text-gray-700">
                    ...
                    <span class="hidden sm:inline font-semibold">ยกเลิก</span>
                </a>
                <div>
            ...
            <div class="flex-shrink-0">
                ...
                <button type="submit" form="create-sales-order-form" class="inline-flex items-center rounded-md bg-indigo-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">
                    สร้างใบสั่งขาย
                </button>
            </div>
        </div>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <form wire:submit="save" id="create-sales-order-form">
